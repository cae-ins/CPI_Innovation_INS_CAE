...
def send_mail_success(destinataires=["bakayokoabdoulaye2809@gmail.com"], cc=["abdoulayebakayoko265@gmail.com"]):
...
def send_mail_error(destinataires=["bakayokoabdoulaye2809@gmail.com"], cc=["abdoulayebakayoko265@gmail.com"]):
